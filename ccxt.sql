...
--
-- Host: localhost    Database: ccxtdatabase
-- ------------------------------------------------------
...
CREATE TABLE `orderbook` (
  ...
  `bid` float(10,4) DEFAULT NULL,
  `ask` float(10,4) DEFAULT NULL,
  `diff_bid` float(10,4) DEFAULT NULL,
  `diff_ask` float(10,4) DEFAULT NULL,
...
-- Dump completed on 2022-07-06  9:44:37
